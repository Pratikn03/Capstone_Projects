...
|---|:---:|---|
| Final PDF outputs | PASS | paper/paper.pdf and repo-root paper.pdf exist and match |
| Compiled manuscript log | PASS | paper/paper.log exists with no LaTeX errors or unresolved references |
| Canonical manuscript authority | PASS | metrics manifest and release manifest both point to paper/paper.tex |
| Solo title page mode | PASS | title page has no draft, committee, or advisor wording |
...
| Claim validator | PASS | [validate_paper_claims] PASS: no findings |

## Summary

- Overall result: **PASS**
- JSON report: `reports/publish/final_submission_audit_report.json`
