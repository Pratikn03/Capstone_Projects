...
class TestProjectionRamp:
    def test_ramp_constraint_applied(self):
        safe, _ = repair_action(
            ...
            {"current_soc_mwh": 50.0},
            _uset(),
            _constraints(ramp_mw=5.0, last_net_mw=0.0),
            _PROJ_CFG,
        )
    ...
    def test_large_ramp_allows_full_action(self):
        safe, _ = repair_action(
            ...
            {"current_soc_mwh": 50.0},
            _uset(),
            _constraints(ramp_mw=100.0, last_net_mw=0.0, discharge_efficiency=1.0),
            _PROJ_CFG,
        )
...
class TestProjectionFTITOverrides:
    def test_ftit_soc_min_overrides(self):
        _, meta = repair_action(
            ...
            {"current_soc_mwh": 50.0},
            _uset(),
            _constraints(ftit_soc_min_mwh=20.0),
            _PROJ_CFG,
        )
    ...
    def test_ftit_soc_max_overrides(self):
        _, meta = repair_action(
            ...
            {"current_soc_mwh": 50.0},
            _uset(),
            _constraints(ftit_soc_max_mwh=70.0),
            _PROJ_CFG,
        )
...
class TestProjectionEfficiency:
    def test_charge_efficiency_affects_next_soc(self):
        safe, meta = repair_action(
            ...
            {"current_soc_mwh": 50.0},
            _uset(),
            _constraints(charge_efficiency=0.90),
            _PROJ_CFG,
        )
...
class TestSafeLanding:
    def test_moves_soc_toward_target_from_above(self):
        ...
        safe, meta = repair_action(
            ...
            {"current_soc_mwh": 92.0},
            _uset(w_t=0.1),
            _constraints(max_soc_mwh=95.0, charge_efficiency=1.0, discharge_efficiency=1.0),
            cfg,
        )
    ...
    def test_moves_soc_toward_target_from_below(self):
        ...
        safe, meta = repair_action(
            ...
            {"current_soc_mwh": 8.0},
            _uset(w_t=0.1),
            _constraints(charge_efficiency=1.0, discharge_efficiency=1.0),
            cfg,
        )
...
class TestEdgeCases:
    def test_zero_capacity(self):
        safe, _ = repair_action(
            ...
            {"current_soc_mwh": 0.0},
            _uset(),
            _constraints(capacity_mwh=0.0, max_soc_mwh=0.0, min_soc_mwh=0.0),
            _PROJ_CFG,
        )
        assert safe["charge_mw"] == 0.0
    ...
    def test_zero_power(self):
        safe, _ = repair_action(
            ...
            {"current_soc_mwh": 50.0},
            _uset(),
            _constraints(max_power_mw=0.0, max_charge_mw=0.0, max_discharge_mw=0.0),
            _PROJ_CFG,
        )
        assert safe["charge_mw"] == 0.0
