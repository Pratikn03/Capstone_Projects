...
| `notebooks/24_publication_package_quality_audit.ipynb` | Publication Package Quality Audit | `reports/publication/tbl_final_*.tex | reports/publication/fig_final_*.png | reports/publication/orius_book_final_results.pdf` | active |
