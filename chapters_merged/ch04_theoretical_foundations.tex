...
\begin{enumerate}
  ...
  \item \textbf{Observation Necessity / No Free Safety} (Chapter~\ref{ch:no-free-safety}):
...
Under Assumptions~A4, A7, and~A9 and confidence level $\delta\in(0,1)$, the validity
