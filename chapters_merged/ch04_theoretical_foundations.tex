...
Under Assumption~A9 and confidence level $\delta\in(0,1)$, the validity
horizon satisfies the lower bound
\[
  \tau_t \;\ge\;
  \left\lfloor\,
...
\begin{proof}
For a $\sigma_d$-sub-Gaussian disturbance, the tail bound
\[
...
\[
  ...
  \frac{\delta_{\text{bnd},t}^2}
       {2\,\sigma_d^2\,\log(2/\delta)}.
\]
Since $\Delta$ must be an integer, flooring gives the claimed lower bound.
\end{proof}
