\chapter{Comprehensive Multi-Domain Fault and Performance Results}
...
This chapter presents the primary empirical results of the multi-domain
...
\input{assets/tables/generated/tbl_battery_leaderboard}%
}
...
\input{paper/assets/tables/generated/tbl_rank_reversal}%
}{%
\input{assets/tables/generated/tbl_rank_reversal}%
}
...
\input{paper/assets/tables/generated/tbl_fault_stress_subset}%
}{%
\input{assets/tables/generated/tbl_fault_stress_subset}%
}
...
The evidence supports a transfer claim: the DE-to-US
...
regional decomposition therefore supports a stronger DC3S safety
...
honest claim supported by the current repo: the safety
...
from pure future-work prose into a measurable extension of DC3S to aging scenarios while
...
The blackout chapter now matches the empirical evidence.  The defended claim
is that certificate validity degrades into a safe-hold path
...
The empirical findings of this chapter establish:
...
\begin{itemize}
  ...
  \item graceful fallback retains materially more useful work than immediate
    shutdown in the recorded trace, and
...
The empirical evidence compares four prolonged-blindness policies directly and
...
the single-asset case.  The current extension is a two-battery shared
...
chapter-facing composition run showing exactly where shared
...
only a conceptual extension.  The two-battery study shows repeated
...
The spoofing-detection audit reports 300 evaluated events with a
...
\begin{table}[ht]
\centering
\caption{Active-probing detection results for the battery threat model.}
...
contains a battery spoofing-detection package with explicit confusion
...
\ref{tab:certos-runtime-summary} summarises the main battery runtime
surface.
