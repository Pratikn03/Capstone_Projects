...
/** Generate sample notifications from mock data context. */
  ...
  return [
    {
      ...
      message: 'Unusual load increase of +1,200 MW in zone DE at 18:00 UTC',
    ...
    },
    {
      id: 'n2',
      type: 'safety',
      title: 'DC3S shield active',
      message: 'Safety shield clamped dispatch command — uncertainty exceeded threshold',
    ...
    },
    {
      ...
      message: 'KS statistic for load_mw exceeded 0.15 threshold. Retraining recommended.',
    ...
    },
    {
      ...
      message: 'Solar output dropped 40% below forecast — possible cloud cover event',
    ...
    },
    {
      id: 'n5',
      type: 'safety',
      title: 'Battery fault cleared',
      message: 'Battery inverter fault in zone US resolved. SOC nominal at 68%.',
