...
with the full theorem-to-code-to-artifact chain.  Industrial process control
and medical monitoring provide defended proof-validated peers on the current
artifact surface.  Autonomous vehicles, aerospace, and navigation remain
tiered rows with narrower claim rights.  That asymmetry is intentional and is
part of the scientific discipline of the manuscript rather than a defect to be
