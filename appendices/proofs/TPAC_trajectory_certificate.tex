...
violation-free with probability at least \(1-\delta\). The same conclusion
holds when the runtime supplies predictable conditional budgets
\(\Pr(Z_t=1\mid\mathcal H_{t-1})\le\epsilon_t\), after taking expectations.
...
supermartingale strengthening and does not require temporal independence.
