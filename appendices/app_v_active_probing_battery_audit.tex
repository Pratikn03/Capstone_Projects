...
detection package and a Byzantine-robust OQE overlay
(\texttt{compute\_reliability\_robust}, activated via
\texttt{adversarial\_mode} in \texttt{dc3s.yaml}), but not a complete
adversarial-safety frontier.
