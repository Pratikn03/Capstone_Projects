...
\begin{description}
  ...
  \item[State definition.] SOC is scalar; the active AV and Healthcare rows carry
    richer state and observation semantics.
...
\begin{table}[ht]
\centering
\caption{Bounded AV excerpt from the shared ORIUS-Bench leaderboard.}
...
This excerpt is useful because it shows the shared contract actually runs beyond
the battery witness row.  It is not useful as evidence of universal DC3S dominance,
...
\begin{enumerate}
  ...
  \item keep the bounded AV and Healthcare rows behind their current evidence
    boundaries until they clear larger denominators,
