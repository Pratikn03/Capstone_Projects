...
\begin{itemize}
  ...
  T11, T11\textsubscript{Byz}, T\textsubscript{stale}, and T\_trajectory\_PAC.
  \item \textbf{Flagship corollary}: T3b.
  \item \textbf{Flagship lemma}: L1--L4.
  \item \textbf{Scoped flagship theorem}: T\textsubscript{minimax} and T\textsubscript{sensor}.
\end{itemize}
...
Table~\ref{tab:theorem-gap-audit} summarises the historical active T1--T11
audit surface.  The publication-ready defended register is now the stricter
promotion matrix, where every active theorem-like row has proof, code, tests,
artifacts, hashes, and a claim boundary.

\begin{table}[htbp]
\centering
\caption{Historical T1--T11 theorem audit summary before promotion-gate closure}
