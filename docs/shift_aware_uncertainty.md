...
- `python scripts/compare_legacy_vs_shift_aware.py --legacy-csv <legacy.csv> --shift-csv <shift.csv>`
- `python scripts/run_shift_aware_acceptance_package.py --legacy-csv <legacy.csv> --shift-csv <shift.csv>`
