...
import pandas as pd
from _battery_wrappers_common import REPO_ROOT, ensure_dir, run_script, write_manifest
...
def main() -> None:
    ...
    write_manifest(
        out,
        "run_spoofing_attack_manifest.json",
        {"source": "reports/publication/active_probing_spoofing_detection.csv"},
    )
