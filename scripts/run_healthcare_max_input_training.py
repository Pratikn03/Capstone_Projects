...
def main() -> int:
    ...
    parser.add_argument(
        "--input", dest="inputs", type=Path, action="append", default=None, help="Input healthcare CSV"
    )
    parser.add_argument(
        "--out-dir", type=Path, default=DEFAULT_MAX_INPUT_OUT, help="Output directory for max-input features"
    )
