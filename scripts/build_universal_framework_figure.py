...
def main() -> None:
    ...
    for i in range(len(stages) - 1):
        ax.annotate(
            "",
            xy=(stages[i + 1][1] - 0.55, 3),
            xytext=(stages[i][1] + 0.55, 3),
    ...
    core_rect = FancyBboxPatch(
        (2, 4.5), 6, 0.8, boxstyle="round,pad=0.02", facecolor=core_color, edgecolor="black", linewidth=1
    )
    ax.add_patch(core_rect)
    ax.text(
        5,
        4.9,
        "ORIUS Universal Physical Safety Framework",
        ha="center",
        va="center",
        fontsize=10,
        fontweight="bold",
    ...
    for i in range(4):
        ...
        ax.annotate(
            ...
            xy=(x_d, 2.4),
            xytext=(x_d, 1.9),
            arrowprops={"arrowstyle": "->", "color": "gray", "lw": 1, "linestyle": "--"},
        )
