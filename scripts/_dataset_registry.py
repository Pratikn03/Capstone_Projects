...
DATASET_REGISTRY: dict[str, DatasetConfig] = {
    "DE": DatasetConfig(
        ...
        canonical_dataset="DE_OPSD",
        compatibility_aliases=("DE", "energy", "OPSD"),
    ...
    "AV": DatasetConfig(
        ...
        canonical_dataset="AV_NUPLAN_ALLZIP_GROUPED",
        compatibility_aliases=("AV", "autonomous_vehicle", "nuPlan", "Waymo", "nuplan_allzip_grouped"),
    ...
    "HEALTHCARE": DatasetConfig(
        ...
        canonical_dataset="MIMIC3_VITALS",
        compatibility_aliases=("HEALTHCARE", "MIMIC", "MIMIC3"),
