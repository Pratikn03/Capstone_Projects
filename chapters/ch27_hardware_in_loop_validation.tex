\chapter{Software-in-the-Loop Validation}
\label{ch:hil}
...
controller or full field deployment robustness.  Those remain open deployment
targets rather than completed claims.

\section{SIL Execution Tables}
