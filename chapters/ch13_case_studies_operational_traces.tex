...
The following case studies are illustrative operational scenarios used to
show \emph{how} the DC3S pipeline behaves under stressed telemetry.  Where a
section is marked \emph{[From locked trace]}, the numerical values are taken
directly from the locked replay artifacts.  Where a section is marked
\emph{[Illustrative]}, the scenario structure is representative and calibrated
to the defended operating envelopes, but it should be interpreted as
``how ORIUS would respond'' rather than as production telemetry from a
deployed system.

\section{48-Hour Case Study [From locked trace]}
...
\section{7-Day Operational Trace [From locked trace]}
...
\section{Price--Dispatch Interaction [From locked trace]}
...
\section{Reliability Score Evolution [From locked trace]}
...
\section{Intervention Timing [From locked trace]}
...
\section{True Versus Observed SOC Divergence [From locked trace]}
...
\section{Failure Avoided by the Shield [Illustrative reconstruction]}
