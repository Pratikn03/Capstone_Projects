...
horizon~$T$ into a single inequality.  The manuscript carries the formal
derivation, while the runtime module
\texttt{src/orius/dc3s/coverage\_theorem.py} now exposes helper
functions that compute the same bound and compare empirical traces against it.

\section{Violation Process and Horizon Notation}
