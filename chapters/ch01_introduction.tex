...
The active theorem inventory spans T1--T11, L1--L4, and scoped extension
rows.  The final promotion gate now assigns each active row to a defended
class rather than leaving draft theorem debt in the register.
\begin{description}
  \item[Flagship theorem.] T1, T2, T3a, T4, T5, T6, T7, T8, T9, T10, T11,
    T11\textsubscript{Byz}, T\textsubscript{stale}, and
    T\textsubscript{trajectory\_PAC}.
  \item[Flagship corollary.] T3b.
  \item[Flagship lemma.] L1--L4.
  \item[Scoped flagship theorem.] T\textsubscript{minimax} and
    T\textsubscript{sensor}, with explicit finite-ambiguity and adapter
