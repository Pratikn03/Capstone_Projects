...
temporal and behavioral dimensions.  Within the authoritative battery
theorem register, this chapter contributes Theorems~T5--T8: certificate
validity horizon, certificate expiration bound, feasible fallback
existence, and graceful degradation dominance.  The certificate half-life
result remains a corollary, and safe-budget monotonicity remains a
proposition.
...
safe zone $\mathcal{X}_{\text{safe}}$ is an absorbing set under the
landing controller (Proposition~\ref{prop:landing-convergence} in
Chapter~\ref{ch:graceful-degradation}), the SOC converges to the
interior and no further violations can occur after landing.
