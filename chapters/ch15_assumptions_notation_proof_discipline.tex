...
\addlinespace
The $\alpha(1-\bar{w})T$ envelope may be only a loose upper bound. & T3, T10 & Upper/lower bound pair for degraded-observation risk & Closed up to a universal constant factor. \\
\addlinespace
Cross-domain portability could be mistaken for equal proof depth. & T11 + tier tables & Explicit structural transfer obligations & Closed at the contract level; empirical discharge remains tiered by domain. \\
\addlinespace
