...
\addlinespace
The AV residual could be misread as a contradiction of the theory. & Universality-completeness chapter (constraint-class mismatch analysis) & Constraint-class mismatch diagnosis & Open promotion gap, but not a contradiction of T1--T11. \\
\addlinespace
Navigation and aerospace rows could be over-read as proof peers. & Claim-boundary discipline in Chapter~\ref{ch:battery-to-orius} & Evidence-tier interpretation & Intentionally outside the proof-validating surface. \\
\bottomrule
\end{tabular}
\end{table}
