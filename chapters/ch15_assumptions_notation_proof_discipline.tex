...
\begin{table}[htbp]
\centering
\caption{Assumption and local-contract dependencies of the active T1--T11 audit surface after promotion-gate closure.}
...
T8 Graceful Degradation Dominance & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & & & & & \checkmark & Shared-fault comparison plus useful-work threshold \\
T9 Mandatory-Release Impossibility & & & & & & & & & & & Nonempty ambiguity class with empty common safe core \\
T10 Boundary-Indistinguishability Lower Bound & & & & & & & & & & & Two-state TV bound plus disjoint safe-action sets \\
...
flat defended ladder.  The registry-canonical defended core now promotes each
active theorem-like surface into one of four classes: flagship theorem,
flagship corollary, flagship lemma, or scoped flagship theorem.  No row remains
a draft theorem inside the defended register; historical draft text is
archived outside the promoted theorem count.
...
\addlinespace
Ignoring reliability may still look operationally attractive. & T4, T9 & Fixed-margin witness and empty-safe-core mandatory-release impossibility & Closed as a scoped structural impossibility result; battery remains the witness surface. \\
\addlinespace
The $\alpha(1-\bar{w})T$ envelope may be only a loose upper bound. & T3, T10 & Conservative upper envelope plus two-state TV lower-bound primitive & Closed conservatively; no global frontier or matching minimax claim is made. \\
\addlinespace
