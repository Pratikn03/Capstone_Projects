...
\Cref{tab:real_data_validation} reports the locked TSVR results.  Industrial achieves 100\,\% TSVR reduction (baseline 1.00, ORIUS 0.00); healthcare achieves 72.1\,\% (baseline 1.00, ORIUS 0.279), both far exceeding the 25\,\% evidence gate.  These results confirm that the DC3S safety-shield pattern transfers to real measured operating conditions in both process-control and clinical-monitoring domains.
