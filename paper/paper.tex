...
\midrule
\multicolumn{4}{l}{\textit{Universal replay: battery reference; industrial + healthcare proof-validated; AV proof-candidate; navigation shadow-synthetic; aerospace experimental}} \\
\bottomrule
\end{tabular}
\end{table}
