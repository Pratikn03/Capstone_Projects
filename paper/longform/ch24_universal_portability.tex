...
All five proof domains exceed the 25\% evidence gate
(Table~\ref{tbl:multi_domain_evidence_gate}).
...
The evidence table above distinguishes \emph{validation depth}:
battery carries locked real-data evidence at the \emph{reference\_validated} tier;
the five proof domains demonstrate evidence-gate passage at the
\emph{proof\_validated} tier on ORIUS-Bench synthetic benchmarks.
The two tiers reflect different depths of empirical validation---not different
