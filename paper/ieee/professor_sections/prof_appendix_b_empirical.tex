...
is exactly what the professor-facing manuscript should emphasize: safety is
...
The appendix table also makes clear why the monograph should not oversell the
...
\noindent In the professor-facing manuscript, this is the right level of detail:
the appendix should show that the safety story is not a single lucky run, but a
reproducible pattern across controller rankings, reliability audits, raw-sequence
stress tests, and trace-level failure avoidance.
