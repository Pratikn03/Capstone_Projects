...
The scientific boundary is intentionally explicit. This draft does not claim equal-domain
closure. Navigation remains blocked by missing defended real-data replay, and aerospace
remains blocked by the absence of a real multi-flight runtime validation surface with
material post-repair gain. Those blockers do not weaken the architectural thesis. They
show that ORIUS is disciplined enough to separate universality of contract from equality
of evidence.
...
them. If the remaining blocked rows are closed, ORIUS supports a stronger universal
claim. Even before that point, it establishes a credible safety-layer grammar for
