...
\begin{figure*}[t]
\centering
\includegraphics[width=0.92\textwidth]{fig_shift_aware_before_after}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.92\textwidth]{fig_shift_aware_before_after_battery}
\caption{Battery domain shift-aware coverage: baseline and adapted coverage
are identical, confirming zero shift under stationary CPSBench replay.}
