...
domain, all four controller configurations achieve $\TSVR = 0$.  In the AV domain,
ORIUS reduces the TSVR from 0.660 (baseline) to 0.628, a relative improvement of
4.8\%.
...
constraint.  The Battery domain exhibits 20 such counterexamples; the AV domain
exhibits 480 OASG cases out of 9{,}348 steps.
...
of the OASG (Definition~\ref{def:oasg}).  Battery domain shown; the AV
counterpart is in \cref{sec:battery}.  Artifact:
