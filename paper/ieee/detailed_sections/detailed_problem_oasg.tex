...
\begin{table}[t]
\caption{Fault families used to instantiate degraded observation.}
\label{tab:oasg_fault_families}
...
grouped nuPlan AV replay row, ORIUS reduces the TSVR from 0.289250 (baseline) to
