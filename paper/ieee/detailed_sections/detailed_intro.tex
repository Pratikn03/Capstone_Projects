...
\begin{enumerate}[nosep]
  ...
  \item A bounded three-domain empirical lane:
        \begin{itemize}[nosep]
          ...
          \item \textbf{AV bounded row}: 9{,}348 runtime steps on the full promoted corpus,
                TSVR reduced from 0.125 (nominal validation harness) to 0.0417
                on the bounded defended row; full-corpus runtime summary remains
                available as a locked artifact.
          \item \textbf{Healthcare bounded row}: TSVR reduced from 0.2917 to 0.0417 on
                the promoted bounded monitoring surface, with grouped calibration and
...
\begin{itemize}[nosep]
  ...
  \item The AV domain is a \emph{bounded proof-validated} row: ORIUS is promoted only
        under the longitudinal TTC + predictive-entry-barrier contract, with full-corpus
        runtime artifacts and a bounded validation-harness comparison.
  \item The Healthcare domain is a \emph{bounded proof-validated} row: ORIUS is promoted
        ...
        Certificate-valid release remains tied to the current governance-pass proxy on this row.
