...
temporal-logic specification~\cite{leucker2009brief,bartocci2018introduction}.  Classic RV
...
online.  Recent work applies CP to robotics and motion
planning~\cite{lindemann2023conformal,dixit2023adaptive}.
...
adapters.  The defended three-domain lane we present combines a battery witness row
with bounded AV and Healthcare rows, demonstrating that the same kernel---compiled
once, configured via adapter---survives domain transfer without changing its runtime
semantics.
