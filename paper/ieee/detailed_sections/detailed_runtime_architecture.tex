...
The dispatch controller (DeepOQE) proposes a 50~MW discharge.
...
The base conformal interval from DeepOQE is $\Chat = [420, 480]$\,MWh (half-width
30~MWh).  With $\wt = 0.976$ and $s_{\mathrm{shift}} = 0$:
\[
