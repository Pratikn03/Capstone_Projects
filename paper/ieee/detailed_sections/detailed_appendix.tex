...
A9 & \textbf{Sub-Gaussian Drift Proxy}: The battery certificate drift process admits a sub-Gaussian scale and a boundary gap supporting the T6 first-passage bound. \\
A10 & \textbf{Boundary-Active Controller}: The quality-ignorant baseline controller used in the T1 witness construction drives the true state within actuator-bounded distance of $\partial\mathcal{S}$ with positive frequency.  Discharged empirically by the non-zero baseline TSVR of the LP arbitrage and no-wrapper policies. \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
T1  & OASG Existence                    & A1, A2, A4, A10 & Proof + Empirical + Code \\
...
T5  & Finite-Horizon Certificate Validity & A1--A5     & Proof + Empirical + Code \\
...
T9  & Mandatory Release Impossibility   & Empty safe core & Proof + Empirical + Code \\
T10 & Boundary-Indistinguishability LB  & Two-state TV & Proof + Empirical + Code \\
T11 & Typed Structural Transfer         & A3--A5, A7, A8 & Proof + Code \\
\bottomrule
\end{longtable}
\normalsize

The defended theorem surfaces have complete formal proofs, while scoped theorem
rows remain claim-boundary constrained in the integrated audit.  The ``Empirical'' tag
