...
remains the witness row with the deepest theorem-to-code-to-artifact closure; AV and
healthcare are defended bounded rows. The central claim is therefore strong but
disciplined: ORIUS establishes a universal runtime safety layer for Physical AI under
degraded observation across the active three-domain program, without claiming broader
empirical closure beyond that repo-truth boundary.
\end{abstract}
...
\input{professor_sections/prof_intro.tex}
\input{professor_sections/prof_problem_oasg.tex}
\input{professor_sections/prof_related_work.tex}
\input{professor_sections/prof_runtime_architecture.tex}
\input{professor_sections/prof_runtime_contracts.tex}
\input{professor_sections/prof_theory_bridge.tex}
\input{professor_sections/prof_battery_results.tex}
\input{professor_sections/prof_results.tex}
\input{professor_sections/prof_cross_domain.tex}
\input{professor_sections/prof_evidence_boundary.tex}
\input{professor_sections/prof_conclusion.tex}
