...
inflating every row into equal novelty.  Every active theorem surface is now
promotion-gated as a flagship theorem, flagship corollary, flagship definition,
or flagship lemma, but several rows are deliberately scoped: finite-horizon
certificates, paired-trace useful-work degradation, mandatory-release
impossibility, two-state boundary lower bounds, and adapter-semantics sensor
necessity.
...
Non-claim & The paper does not claim global minimax optimality, equal deployment readiness, or flat closure beyond the defended three-domain lane.\\
\bottomrule
\end{tabularx}
\end{table}
...
equalized across domains already. The generated theorem promotion matrix and
