...
vehicles, healthcare monitoring, and future additional domains without pretending those
settings share the same nominal controller or safety geometry.

The evidence claim is intentionally disciplined. Battery is the witness row. AV and
Healthcare are defended bounded rows. Future additional domains remain outside the
current defended lane. That asymmetry does not weaken the architectural claim. It is
what makes the paper scientifically credible: ORIUS can be universal in runtime
contract while still governed by a public promotion discipline.
