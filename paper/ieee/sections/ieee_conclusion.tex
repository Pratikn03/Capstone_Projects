...
vehicles, and healthcare monitoring without pretending those settings share the same
nominal controller or safety geometry.

The evidence claim is intentionally disciplined. Battery is the primary validation
domain. AV is validated on all-zip grouped nuPlan replay. Healthcare is validated as a
bounded retrospective monitoring domain. Future additional domains remain outside the
current evidence boundary. That asymmetry does not weaken the architectural claim. It
is what makes the paper scientifically credible: ORIUS can be universal in runtime
contract while still governed by explicit claim-evidence criteria.
...
through one benchmark schema and one governance surface. If additional domains later
clear the same closure obligations, the architecture can support a broader empirical
claim. Even before that point, ORIUS establishes a reusable safety-layer grammar for
Physical AI under degraded observation.
