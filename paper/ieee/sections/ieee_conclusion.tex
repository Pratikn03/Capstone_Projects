...
The evidence claim is intentionally disciplined. Battery is the witness row. AV is an
all-zip grouped nuPlan replay row. Healthcare is a bounded retrospective monitoring row. Future
additional domains remain outside the current defended lane. That asymmetry does not
weaken the architectural claim. It is what makes the paper scientifically credible:
ORIUS can be universal in runtime contract while still governed by a public promotion
discipline.
