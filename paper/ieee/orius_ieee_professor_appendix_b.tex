...
artifact-grounded and reuses the same publication surfaces that support the canonical
dissertation, rather than local dashboard snapshots or independently written summaries.
...
\ORIUSReuseInput{../monograph/ch06_benchmark_and_reproducibility_protocol.tex}
...
\ORIUSReuseInput{../review/generated/review_domain_protocol_cards.tex}
