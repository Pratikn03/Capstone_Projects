...
\PaperFigure{FIG01_ARCHITECTURE}{GridPulse architecture with \DCThreeS{} at the dispatch boundary. The shield wraps the optimizer, inflating intervals and repairing actions before execution.}
