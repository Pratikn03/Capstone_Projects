...
\PaperFigure{FIG01_ARCHITECTURE}{ORIUS architecture with \DCThreeS{} at the dispatch boundary. The shield consumes telemetry quality, forecast intervals, and optimizer output before command execution.}
