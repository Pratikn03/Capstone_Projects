...
\midrule
Real raw-source contract & blocked\_real\_data\_gap & Install the canonical KITTI-backed real-data row under ORIUS\_EXTERNAL\_DATA\_ROOT and retire synthetic fallback from the defended path.\\
