...
\midrule
Real telemetry source & placeholder\_surface & Add the defended multi-flight telemetry replay surface alongside the C-MAPSS training row before treating the chapter as anything stronger than an outer-boundary report.\\
