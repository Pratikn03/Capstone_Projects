...
The aerospace training artifacts are presented precisely because they reveal the current boundary: features, splits, and week-two metrics exist, but the parity gate still marks the row as placeholder-level until a real multi-flight telemetry source and stronger safety task are installed. In parallel, the bounded public-flight runtime lane converts public ADS-B telemetry into the ORIUS runtime contract with explicit proxy labels on groundspeed-derived airspeed, heading-rate bank-angle estimates, and normalized fuel-progress fields.

\IfFileExists{paper/assets/tables/generated/tbl_aerospace_training_surface.tex}{%
\input{paper/assets/tables/generated/tbl_aerospace_training_surface}%
}{%
\input{assets/tables/generated/tbl_aerospace_training_surface}%
}
...
\input{paper/assets/tables/generated/tbl_aerospace_replay_surface}%
}{%
\input{assets/tables/generated/tbl_aerospace_replay_surface}%
}
...
The aerospace row is valuable because it exposes the outer boundary of the universal contract. The current placeholder training and replay surfaces are strong enough to discuss scope, fallback, and promotion requirements, but not strong enough to claim defended aerospace closure. A bounded public-flight ADS-B support lane now contributes 8 rows across 1 flights with a bounded contract-pass rate of 1.000, but that lane is explicitly marked supplemental and non-promotional.
...
\IfFileExists{paper/assets/tables/generated/tbl_aerospace_public_flight_support.tex}{%
\input{paper/assets/tables/generated/tbl_aerospace_public_flight_support}%
}{%
\input{assets/tables/generated/tbl_aerospace_public_flight_support}%
}


\IfFileExists{paper/assets/tables/generated/tbl_aerospace_promotion_obligations.tex}{%
\input{paper/assets/tables/generated/tbl_aerospace_promotion_obligations}%
}{%
\input{assets/tables/generated/tbl_aerospace_promotion_obligations}%
}
