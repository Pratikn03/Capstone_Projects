...
Concretely, the paper-facing surface is organized around four flagship theorem
roles: the observation--action safety gap, observation necessity, ORIUS covered
release preservation, and typed transfer under domain obligations. The permanent
T1--T11 labels are retained as audit identifiers, not as a requirement that every
numbered item be promoted to a headline theorem in the paper.
...
The paper-facing theory chapter carries four flagship theorem roles and a small
set of supporting propositions/corollaries.  The full T1--T11 ladder remains in
Appendix~\ref{app:proofs} and in the theorem registry for traceability; the paper
does not ask the reader to treat all eleven identifiers as equally central main
theorems.  The claim is deliberately conditional: ORIUS is safety-optimal under
covered observation ambiguity, not globally optimal for every possible
physical-AI system.
