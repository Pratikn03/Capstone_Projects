...
from gridpulse.forecasting.uncertainty.cqr import assign_bins, cqr_scores, rolling_volatility
...
class RACCertConfig:
    ...
    n_vol_bins: int = 3
    vol_window: int = 24
    beta_reliability: float = 0.7
    beta_sensitivity: float = 0.5
    k_sensitivity: float = 0.4
    infl_max: float = 3.0
    sens_eps_mw: float = 25.0
    sens_norm_ref: float = 0.5
    qhat_shrink_tau: float = 30.0
    max_q_multiplier: float = 3.0
    min_w: float = 0.05
    eps: float = 1e-9
