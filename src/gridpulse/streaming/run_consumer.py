...
def _build_app_config(payload: dict[str, Any]) -> Any:
    ...
    return AppConfig(
        kafka=ConsumerConfig(
            ...
            topic=str(kafka_cfg.get("topic", "gridpulse.opsd.v1")),
            group_id=str(kafka_cfg.get("group_id", "gridpulse-consumer")),
...
def main() -> None:
    ...
    from gridpulse.streaming.consumer import StreamingIngestConsumer
