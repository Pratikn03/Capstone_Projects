"""
Prometheus Metrics Integration for ORIUS API.
...
REQUESTS_TOTAL = Counter(
    "orius_requests_total",
    "Total number of requests",
    ["endpoint", "method", "status"],
)

REQUEST_DURATION = Histogram(
    "orius_request_duration_seconds",
...
REQUEST_ERRORS = Counter(
    "orius_request_errors_total",
    "Total number of request errors",
    ["endpoint", "method", "error_type"],
)

REQUESTS_IN_PROGRESS = Gauge(
    "orius_requests_in_progress",
...
FORECAST_DURATION = Histogram(
    "orius_forecast_duration_seconds",
...
OPTIMIZATION_DURATION = Histogram(
    "orius_optimization_duration_seconds",
...
ANOMALIES_DETECTED = Counter(
    "orius_anomalies_detected_total",
...
KAFKA_MESSAGES_CONSUMED = Counter(
    "orius_kafka_messages_consumed_total",
    "Total messages consumed from Kafka",
    ["topic"],
)

STREAMING_PROCESSING_DELAY = Gauge(
    "orius_streaming_processing_delay_seconds",
...
WATCHDOG_LAST_BEAT = Gauge(
    "orius_watchdog_last_beat_seconds",
    "Seconds since last watchdog heartbeat",
)

SAFETY_VIOLATIONS = Counter(
    "orius_safety_violations_total",
...
MODEL_LAST_TRAINED = Gauge(
    "orius_model_last_trained_timestamp",
