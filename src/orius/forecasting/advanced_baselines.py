...
class ProphetBaseline(BaselineModel):
    ...
    def fit(self, df: pd.DataFrame) -> ProphetBaseline:
        ...
        try:
            ...
            raise ImportError("Prophet not installed. Run: pip install prophet") from exc
...
class NBEATSBaseline(BaselineModel):
    ...
    def fit(self, df: pd.DataFrame) -> NBEATSBaseline:
        ...
        try:
            ...
            raise ImportError("Darts not installed. Run: pip install darts") from exc
...
class AutoMLConfig(BaselineConfig):
    ...
    estimator_list: list[str] = field(
        default_factory=lambda: ["lgbm", "xgboost", "rf", "extra_tree", "xgb_limitdepth"]
    )
...
class AutoMLBaseline(BaselineModel):
    ...
    def fit(self, df: pd.DataFrame) -> AutoMLBaseline:
        ...
        try:
            ...
            raise ImportError("FLAML not installed. Run: pip install flaml[automl]") from exc
    ...
    def get_feature_importance(self) -> dict[str, float]:
        ...
        try:
            ...
            return dict(zip(self._feature_cols, importance, strict=False))
