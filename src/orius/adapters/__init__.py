...
_EXPORTS = {
    ...
    "IndustrialDomainAdapter": ("orius.adapters.industrial", "IndustrialDomainAdapter"),
    "IndustrialTrackAdapter": ("orius.adapters.industrial", "IndustrialTrackAdapter"),
    ...
    "AerospaceDomainAdapter": ("orius.adapters.aerospace", "AerospaceDomainAdapter"),
    "AerospaceTrackAdapter": ("orius.adapters.aerospace", "AerospaceTrackAdapter"),
    "NavigationDomainAdapter": ("orius.adapters.navigation", "NavigationDomainAdapter"),
    "NavigationTrackAdapter": ("orius.adapters.navigation", "NavigationTrackAdapter"),
